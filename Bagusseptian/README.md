{
   tokens: {
      // Main Token (ex: Nz...)
      main: 'ODIzMTczNTA5MjA2Mzc2NDk4.YFc-Eg.HN8LR2a3ApjzkpgPFSmkRpDhf_E',
      // Alt Tokens (ex: Nz...)
      alts: [
         '',
      ],
   ...
   */
   ...
   webhook: {
      ...
      url: 'https://discord.com/api/webhooks/885349099518447666/PlbZJvT0OYEDDaXXYktkYMrItPMMJKF5yga8orqqNhoAPuSRsvnIjQCS93q_XRMu_l-N',
      enabled: {
